...
const String deviceToken = "6znADLcLK6GCVy3KNuuCi8z1B";
const char wifiSSID[] = "Vodafoneebeb";       // inserire l'ssid della rete
const char wifiPassword[] = "1lUB4jV1pdCCczvNdMyOvQQK";   // password della rete
